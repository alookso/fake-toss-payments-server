...
exports.test_storage_expiration_time = void 0;
...
function test_storage_expiration_time() {
    return __awaiter(this, void 0, void 0, function () {
        var time, previous, i, payment;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    time = FakeTossConfiguration_1.TossFakeConfiguration.EXPIRATION.time;
                    FakeTossStorage_1.FakeTossStorage.payments.clear();
                    FakeTossConfiguration_1.TossFakeConfiguration.EXPIRATION.time = 1;
                    previous = null;
                    i = 0;
                    _a.label = 1;
                case 1:
                    if (!(i < 10)) return [3 /*break*/, 8];
                    return [4 /*yield*/, api_1.default.functional.v1.payments.key_in(TestConnection_1.TestConnection.FAKE, {
                            method: "card",
                ...
                case 2:
                    ...
                    (function (input) { (function (input, path) {
                        ...
                        return $predicate(null !== input && $predicate("object" === typeof input && null !== input && $ao[0](input, path + "", true), true, function () { return ({
                            path: path + "",
                            expected: "Resolve<ITossCardPayment>",
                            value: input
                    ...
                    return [4 /*yield*/, (0, global_1.sleep_for)(1)];
                case 3:
                    _a.sent();
                    if (!(previous !== null)) return [3 /*break*/, 5];
                    return [4 /*yield*/, (0, exception_must_be_thrown_1.exception_must_be_thrown)("VirtualTossStorageProvider.payments.get() for expired record", function () {
                            return api_1.default.functional.v1.payments.at(TestConnection_1.TestConnection.FAKE, previous);
                        })];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5: return [4 /*yield*/, api_1.default.functional.v1.payments.at(TestConnection_1.TestConnection.FAKE, payment.paymentKey)];
                case 6:
                    _a.sent();
                ...
                case 7:
                    ...
                    return [3 /*break*/, 1];
                case 8:
                    FakeTossConfiguration_1.TossFakeConfiguration.EXPIRATION.time = time;
                    return [2 /*return*/];
            }
        });
    });
}
exports.test_storage_expiration_time = test_storage_expiration_time;
//# sourceMappingURL=test_storage_expiration_time.js.map