...
export declare class FakeTossBillingController {
     ...
     */
    store(request: express.Request, input: ITossBilling.IStore): ITossBilling;
    /**
     * 간편 결제로 등록한 수단 조회하기.
     *
     ...
     * @author Jeongho Nam - https://github.com/samchon
     */
    at(request: express.Request, billingKey: string, input: ITossBilling.ICustomerKey): ITossBilling;
    /**
     ...
     * @author Jeongho Nam - https://github.com/samchon
     */
    pay(request: express.Request, billingKey: string, input: ITossBilling.IPaymentStore): ITossPayment;
}
