...
export declare class FakeTossPaymentsController {
    /**
     * 결제 정보 조회하기.
     *
     ...
     */
    at(request: express.Request, paymentKey: string): ITossPayment;
    /**
     * 카드로 결제하기.
     *
     ...
     * @author Jeongho Nam - https://github.com/samchon
     */
    key_in(request: express.Request, input: ITossCardPayment.IStore): ITossCardPayment;
    /**
     * 결제 승인하기.
     *
     ...
     * @author Jeongho Nam - https://github.com/samchon
     */
    approve(request: express.Request, input: ITossPayment.IApproval): ITossPayment;
    /**
     * 결제 취소하기.
     *
     ...
     * @author Jeongho Nam - https://github.com/samchon
     */
    cancel(request: express.Request, paymentKey: string, input: ITossPaymentCancel.IStore): ITossPayment;
}
