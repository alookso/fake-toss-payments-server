...
export declare namespace ITossBilling {
    /**
     * 간편 결제 카드 등록 정보.
     */
    interface IStore extends ICustomerKey {
        /**
         * 카드 번호.
         */
        cardNumber: string;
     ...
     * 간편 결제를 이용한 결제 신청 정보.
     */
    interface IPaymentStore extends ICustomerKey {
        /**
         * 결제 수단이 간편 결제임을 의미함.
         */
        method: "billing";
     ...
     * 수단 정보를 취득할 수 있다.
     */
    interface IAccessor extends ICustomerKey {
        /**
