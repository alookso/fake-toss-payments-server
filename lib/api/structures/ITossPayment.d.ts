 ...
 */
export declare type ITossPayment = ITossCardPayment | ITossGiftCertificatePayment | ITossMobilePhonePayment | ITossTransferPayment | ITossVirtualAccountPayment;
export declare namespace ITossPayment {
    /**
     * 결제의 기본 정보.
     */
    interface IBase<Method extends string, Type extends string, Status extends string = "READY" | "IN_PROGRESS" | "WAITING_FOR_DEPOSIT" | "DONE" | "CANCELED" | "PARTIAL_CANCELED" | "ABORTED" | "EXPIRED"> {
        /**
         * 결제 수단.
         */
        method: Method;
     ...
     * ```
     */
    type IStore = ITossCardPayment.IStore | ITossBilling.IPaymentStore | ITossVirtualAccountPayment.IStore;
}
