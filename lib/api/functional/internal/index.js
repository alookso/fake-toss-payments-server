...
function webhook(connection, input) {
    return nestia_fetcher_1.Fetcher.fetch(connection, webhook.ENCRYPTED, webhook.METHOD, webhook.path(), input);
}
exports.webhook = webhook;
(function (webhook) {
    webhook.METHOD = "POST";
    webhook.PATH = "/internal/webhook";
    webhook.ENCRYPTED = {
        request: false,
        response: false,
    };
...
function deposit(connection, paymentKey) {
    return nestia_fetcher_1.Fetcher.fetch(connection, deposit.ENCRYPTED, deposit.METHOD, deposit.path(paymentKey));
}
exports.deposit = deposit;
(function (deposit) {
    deposit.METHOD = "GET";
    deposit.PATH = "/internal/:paymentKey/deposit";
    deposit.ENCRYPTED = {
        request: false,
        response: false,
    };
    function path(paymentKey) {
        return "/internal/".concat(paymentKey, "/deposit");
    }
    deposit.path = path;
