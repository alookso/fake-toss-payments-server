 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function webhook(connection: IConnection, input: Primitive<webhook.Input>): Promise<void>;
export declare namespace webhook {
    type Input = Primitive<ITossPaymentWebhook>;
    const METHOD: "POST";
    const PATH: string;
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function deposit(connection: IConnection, paymentKey: string): Promise<deposit.Output>;
