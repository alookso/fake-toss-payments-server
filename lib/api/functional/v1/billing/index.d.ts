 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function pay(connection: IConnection, billingKey: string, input: Primitive<pay.Input>): Promise<pay.Output>;
export declare namespace pay {
    type Input = Primitive<ITossBilling.IPaymentStore>;
