 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function at(connection: IConnection, billingKey: string, input: Primitive<at.Input>): Promise<at.Output>;
export declare namespace at {
    type Input = Primitive<ITossBilling.ICustomerKey>;
    type Output = Primitive<ITossBilling>;
    const METHOD: "POST";
    const PATH: string;
    const ENCRYPTED: Fetcher.IEncrypted;
    function path(billingKey: string): string;
}
