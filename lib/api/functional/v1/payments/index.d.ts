 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function at(connection: IConnection, paymentKey: string): Promise<at.Output>;
export declare namespace at {
    type Output = Primitive<ITossPayment>;
    const METHOD: "GET";
    const PATH: string;
    const ENCRYPTED: Fetcher.IEncrypted;
    function path(paymentKey: string): string;
}
/**
 * 카드로 결제하기.
 *
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function key_in(connection: IConnection, input: Primitive<key_in.Input>): Promise<key_in.Output>;
export declare namespace key_in {
    type Input = Primitive<ITossCardPayment.IStore>;
    type Output = Primitive<ITossCardPayment>;
    const METHOD: "POST";
    const PATH: string;
    const ENCRYPTED: Fetcher.IEncrypted;
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export declare function cancel(connection: IConnection, paymentKey: string, input: Primitive<cancel.Input>): Promise<cancel.Output>;
export declare namespace cancel {
    type Input = Primitive<ITossPaymentCancel.IStore>;
    type Output = Primitive<ITossPayment>;
    const METHOD: "POST";
    const PATH: string;
    const ENCRYPTED: Fetcher.IEncrypted;
