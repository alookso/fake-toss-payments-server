 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
function approve(connection, input) {
    return nestia_fetcher_1.Fetcher.fetch(connection, approve.ENCRYPTED, approve.METHOD, approve.path(), input);
}
exports.approve = approve;
(function (approve) {
    approve.METHOD = "POST";
    approve.PATH = "/v1/payments/confirm";
    approve.ENCRYPTED = {
        request: false,
        response: false,
    };
    function path() {
        return "/v1/payments/confirm";
    }
    approve.path = path;
})(approve = exports.approve || (exports.approve = {}));
