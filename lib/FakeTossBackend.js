...
var FakeTossBackend = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        // MOUNT CONTROLLERS
                        _a = this;
                        _c = (_b = core_1.NestFactory).create;
                        return [4 /*yield*/, nestia_helper_1.default.EncryptedModule.dynamic(__dirname + "/controllers", FakeTossConfiguration_1.TossFakeConfiguration.ENCRYPTION_PASSWORD)];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent(), { logger: false }])];
                    case 2:
                        //----
                        // OPEN THE BACKEND SERVER
                        //----
                        // MOUNT CONTROLLERS
                        _a.application_ = _d.sent();
                        // CONFIGURATIONS
                        this.is_closing_ = false;
                        this.application_.enableCors();
                        this.application_.use(this.middleware.bind(this));
                        // DO OPEN
                        return [4 /*yield*/, this.application_.listen(FakeTossConfiguration_1.TossFakeConfiguration.API_PORT)];
                    case 3:
                        // DO OPEN
                        _d.sent();
                        //----
    ...
    FakeTossBackend.prototype.middleware = function (_request, response, next) {
